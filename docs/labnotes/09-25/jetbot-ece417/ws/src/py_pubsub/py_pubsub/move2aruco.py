...
class MoveToARUCO:
    ...
    def on_aruco_detection(self, msg):
        ...
        if not len(msg.markers):
            ...
            return new_twist(-linear_vel_clipped, ang_vel_clipped)
...
class MoveToARUCONode(Node):
    def __init__(self):
        ...
        self.timer = None
        self.move2aruco = MoveToARUCO(self.get_logger())

    def on_aruco_detection(self, msg):
        self.pub.publish(
                self.move2aruco.on_aruco_detection(msg)
                )
